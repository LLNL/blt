...
# If BLT_CUDA_TOOLKIT_ROOT_DIR is not set, it should be set by find_package(CUDA)
find_package(CUDA REQUIRED)

blt_assert_exists( DIRECTORIES ${BLT_CUDA_TOOLKIT_ROOT_DIR} )

# Append the path to the NVIDIA SDK to the link flags
if ( IS_DIRECTORY "${BLT_CUDA_TOOLKIT_ROOT_DIR}/lib64" )
    list(APPEND CMAKE_CUDA_LINK_FLAGS "-L${BLT_CUDA_TOOLKIT_ROOT_DIR}/lib64" )
endif()
if ( IS_DIRECTORY "${BLT_CUDA_TOOLKIT_ROOT_DIR}/lib}" )
    list(APPEND CMAKE_CUDA_LINK_FLAGS "-L${BLT_CUDA_TOOLKIT_ROOT_DIR}/lib" )
endif()

message(STATUS "CUDA Version:                   ${CUDA_VERSION_STRING}")
message(STATUS "CUDA Toolkit Root Dir:          ${BLT_CUDA_TOOLKIT_ROOT_DIR}")
...
if (BLT_ENABLE_CLANG_CUDA)
    set (_cuda_compile_flags -x cuda --cuda-gpu-arch=${BLT_CLANG_CUDA_ARCH} --cuda-path=${BLT_CUDA_TOOLKIT_ROOT_DIR})
