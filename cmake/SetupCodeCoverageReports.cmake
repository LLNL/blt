...
function(blt_add_code_coverage_target)
    ...
    add_custom_target(${arg_NAME}
        ...
        COMMAND ${LCOV_EXECUTABLE} --no-external --gcov-tool ${GCOV_EXECUTABLE} ${_coverage_directories} --remove ${arg_NAME}.info '/usr/include/*' --exclude '*/unitTests/*' --output-file ${arg_NAME}.info.cleaned
